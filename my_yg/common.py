...
def script_main(download, download_playlist, my_args, **kwargs):
...
def url_to_module(url):
    ...
    if k in SITES:
        return (
            import_module('.'.join(['my_yg', 'extractors', SITES[k]])),
            url
        )
    else:
        import http.client
        ...
        if location and location != url and not location.startswith('/'):
            ...
            return import_module('my_yg.extractors.universal'), url
